...
const Present = () => {
  return (
    <div className="presentation flex flex-col items-center justify-center min-h-screen bg-cover bg-center bg-no-repeat text-white text-center">
      <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-wider text-center"
      style={{ fontFamily: "Vipnagorgialla", color: "var(--text)" }}>Mathieu FENOUIL</h2>
      <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light uppercase mt-4 text-center"
      style={{ fontFamily: "Techovier", color: "var(--text)" }}>Développeur Front-End</h3>
