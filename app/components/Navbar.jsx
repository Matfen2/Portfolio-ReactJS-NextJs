  ...
  return (
    <nav className="bg-[var(--background)] text-[var(--text)] border-[var(--border)] fixed w-full top-0 z-50 shadow-md border-b-2" >
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        {/* Links */}
        <ul
          className={`md:flex md:space-x-8 items-center md:static absolute top-14 left-0 w-full md:w-auto bg-[var(--background)] transition-all duration-300 ease-in-out ${
            isOpen ? "block" : "hidden"
          }`} style={{ border: "var(--border)"}}
        >
          <li className="block px-4 py-2 text-center">
            <a href="#about-section" className="transition-colors duration-300 text-xl ease-in-out hover:scale-105" style={{
            color: "var(--text)", fontFamily: "Honor", letterSpacing: "1px", textDecoration: "none" }}>À propos</a>
          </li>
          <li className="block px-4 py-2 text-center">
